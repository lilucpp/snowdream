...
#define P1(x) ((x) ^  ROTL((x),15) ^ ROTL((x),23)) 
    ...
    printf("   %08x %08x %08x %08x %08x %08x %08x %08x\n",(unsigned int)A,(unsigned int)B,(unsigned int)C,(unsigned int)D,(unsigned int)E,(unsigned int)F,(unsigned int)G,(unsigned int)H);
#endif
	...
	for(j =0; j < 16; j++)
	{
		...
		E = P0(TT2);
#ifdef _DEBUG_LOG 
        printf("%02d %08x %08x %08x %08x %08x %08x %08x %08x\n",(unsigned int)j,(unsigned int)A,(unsigned int)B,(unsigned int)C,(unsigned int)D,(unsigned int)E,(unsigned int)F,(unsigned int)G,(unsigned int)H);
#endif
	}
    ...
    ctx->state[7] ^= H;
#ifdef _DEBUG_LOG 
       printf("   %08x %08x %08x %08x %08x %08x %08x %08x\n",(unsigned int)ctx->state[0],(unsigned int)ctx->state[1],(unsigned int)ctx->state[2],
                                  (unsigned int)ctx->state[3],(unsigned int)ctx->state[4],(unsigned int)ctx->state[5],(unsigned int)ctx->state[6],(unsigned int)ctx->state[7]);
#endif
}
