...
// fs::fstream use path constructor
// Class path takes care of whatever character type or encoding conversions are
// required by the particular operating system.
int main() {
